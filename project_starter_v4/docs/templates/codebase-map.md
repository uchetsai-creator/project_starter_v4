...
<!--
  ...
  Generated by: python3 docs/script/component_to_html.py docs/codebase-map.md
  Output file:  docs/codebase-map-component.html (picked up automatically by build_pdf.py)
